...
if(isset($_POST["submit"])){
    ...
    $result = mysqli_query($conn, "SELECT * FROM acc WHERE username = '$usernameemail' OR email = '$usernameemail'");
                ...
                <div class="form-box login">
                    ...
                    <form class="" action="" method="post" autocomplete="off">
                        <div class="input-box">
                            ...
                            <input type="text" name="usernameemail" id="usernameemail" required value="admin">
